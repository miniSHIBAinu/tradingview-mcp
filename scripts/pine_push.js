...
const port = process.env.TV_CDP_PORT || process.env.CDP_PORT || '9333';
const host = process.env.TV_CDP_HOST || process.env.CDP_HOST || 'localhost';
...
const c = await CDP({ host, port: Number(port), target: t.id });
